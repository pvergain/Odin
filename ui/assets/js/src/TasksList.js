...
class ListItem extends React.Component {
  ...
  render() {
    ...
    const editUrl = !this.props.competition
      ? Urls['dashboard:education:course-management:edit-included-task']({
          course_id: this.props.course,
          task_id: this.props.task.id,
        })
      : Urls['competitions:edit-competition-task']({
          competition_slug: this.props.competition.slug_url,
          task_id: this.props.task.id,
        });
          ...
          <div className="row">
            ...
            <div className="col-md-5">
              <div className="btn-group pull-right">
                ...
                {role ? (
                  <a href={editUrl} className="btn btn-default uppercase">
                    Edit
                  </a>
                ) : (
                  <a
